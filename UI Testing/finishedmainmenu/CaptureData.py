...
class Ui_CaptureData(object):
    def setupUi(self, CaptureData):
        CaptureData.setObjectName("CaptureDataForm")
        CaptureData.resize(309, 220)
        ...
        self.Mainmenu = QtWidgets.QPushButton(CaptureData)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout.addWidget(self.Mainmenu, 2, 0, 1, 2)
    ...
    def retranslateUi(self, CaptureData):
        ...
        self.Mainmenu.setText(_translate("CaptureData", "Main Menu"))
